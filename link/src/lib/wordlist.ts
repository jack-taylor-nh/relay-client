// Subset of the English BIP39 word list for seed generation.
// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt (public domain).
...
export const WORDLIST: readonly string[] = [
  ...
  "arrive","arrow","art","artefact","artist","artwork","ask","asleep","aspect","assault",
  ...
  "coat","coconut","code","coffee","coil","coin","collect","color","column","combine",
  ...
  "display","distance","divide","divorce","dizzy","doctor","document","dog","doll","dolphin",
  ...
  "fragile","frame","freckle","freedom","freeze","frequent","fresh","friend","fringe","frog",
  ...
  "march","margin","marine","market","marriage","mask","massive","master","match","material",
  ...
  "scout","scrap","screen","script","scroll","seal","search","season","seat","second",

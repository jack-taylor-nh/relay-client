import { edges, createEdge, burnEdge, showToast, loadEdges, edgeTypes, selectedConversationId } from '../state';
...
import { Plus, Copy, FileText, Trash2, ChevronDown, MessageSquare, X } from 'lucide-react';
...
export function FullscreenEdgesView() {
  ...
  return (
    <div className="flex h-full">
      {/* Edges List - Left Panel */}
      <div className="w-96 flex-shrink-0 flex flex-col border-r border-[hsl(var(--border))] bg-[hsl(var(--card))] relative">

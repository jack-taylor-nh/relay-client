      ...
      <div class="flex-1 flex flex-col bg-stone-50">
        {!selectedEdge.value ? (
          ...
          <div class="flex-1 flex flex-col items-center justify-center text-center px-5">
            ...
            <p class="text-stone-500">Select an edge to send from</p>
          </div>
        ) : (
          ...
          <div class="flex-1 flex flex-col max-w-2xl mx-auto w-full p-6">
            <div class="flex items-center gap-3 mb-6 pb-4 border-b border-stone-200">
              ...
              <div>
                <h3 class="text-lg font-semibold text-stone-900">New Conversation</h3>
              ...
              <div class="flex-1">
                ...
                <div class="flex gap-2 mb-2">
                  <div class="relative flex-1">
                    ...
                    <input
                      type="text"
                      class="w-full pl-7 pr-3 py-3 text-base border border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent"
                  ...
                  <button
                    class="px-6 py-3 text-base font-semibold text-white bg-slate-700 hover:bg-slate-800 disabled:bg-stone-300 rounded-lg transition-colors"
              ...
              <div class="flex-1 flex flex-col">
                ...
                <div class="p-4 bg-white border border-stone-200 rounded-lg mb-4">
                  <div class="flex items-center justify-between">
                    <div>
                      <div class="text-base font-semibold text-stone-900">&{resolvedUser.handle}</div>
                      <div class="text-sm font-mono text-stone-500">{resolvedUser.fingerprint.slice(0, 16)}...</div>
                    </div>
                    <button
                ...
                <div class="flex-1 flex flex-col">
                  ...
                  <textarea
                    class="flex-1 min-h-[200px] px-4 py-3 text-base border border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent resize-none"
                ...
                <button
                  class="mt-4 w-full px-6 py-3 text-base font-semibold text-white bg-slate-700 hover:bg-slate-800 disabled:bg-stone-300 disabled:cursor-not-allowed rounded-lg transition-colors"
                  onClick={handleSend}

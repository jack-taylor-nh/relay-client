  ...
  return (
    <header class="flex items-center justify-between px-4 py-3 bg-[var(--color-bg-elevated)] border-b border-[var(--color-border-default)]">
      ...
      <div class="flex items-center gap-2">
        {handle && (
          <button 
            class="px-3 py-1.5 text-sm font-medium text-[var(--color-text-secondary)] bg-[var(--color-bg-sunken)] border border-[var(--color-border-default)] rounded-md hover:bg-[var(--color-bg-hover)] hover:border-[var(--color-border-strong)] transition-all duration-150 cursor-pointer"
            onClick={() => {
        ...
        {/* Theme toggle button */}
        <button
          class="p-2 text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-bg-hover)] rounded-md transition-all duration-150 cursor-pointer"
          onClick={toggleTheme}
        ...
        {!isFullscreen && (
          <button
            class="p-2 text-[var(--color-text-secondary)] hover:text-[var(--color-error)] hover:bg-[var(--color-bg-hover)] rounded-md transition-all duration-150 cursor-pointer"
            onClick={handleClose}
            title="Close"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
